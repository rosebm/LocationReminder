...
class GeofenceTransitionsJobIntentService : JobIntentService(), CoroutineScope {
    ...
    companion object {
        ...
        //This will start the JobIntentService to handle the geofencing transition events
    ...
    private fun sendNotification(triggeringGeofences: List<Geofence>) {
        // Get the first triggered geofence and use its requestId to find the associated
        // reminder object from the repository
